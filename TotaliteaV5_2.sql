...
DECLARE 
	...
	emcmsg VARCHAR2(120);
BEGIN
	insertUser('Stuart', 'Stuart@hotmail.com', 'horse', '10 downing street London W7 1BW', 1, to_Date('01/11/2021 09:30:00', 'DD/MM/YYYY HH24:MI:SS'), userID, emcmsg);
	...
	insertUser('user1', 'user1@hotmail.com', 'van', '15 compton avenue Derby  DE7 22A', 0, to_Date('01/11/2021 09:30:00', 'DD/MM/YYYY HH24:MI:SS'), userID, emcmsg);
	DBMS_OUTPUT.PUT_LINE(emcmsg);
