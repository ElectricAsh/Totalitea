...
IS
BEGIN
	INSERT INTO Products (ProductType, ProductName, Description, MedicanlUse, CaffeineAmt, Category, 
...
BEGIN
	...
	insertProducts('caffeinated', 'espresso', 'black', 'improve concentration', 212, 'Drink', 'azera', 4.20, 100, 0, 0, 0, 0, aprod); 
	insertOrders(seq_orderid.nextval, aprod, auser, to_Date('04/11/2019 15:10:00', 'DD/MM/YYYY HH24:MI:SS'));
	insertProducts('decaff', 'Earl Grey', 'grey', 'improve digestion', 95, 'Drink', 'Twinings', 4.00, 250, 0, 0, 0, 0, aprod); 
	insertOrders(seq_orderid.currval, aprod, auser, to_Date('04/11/2019 15:10:00', 'DD/MM/YYYY HH24:MI:SS'));
	insertProducts('caffeinated', 'Cappuccino', 'brown', 'source of useful antioxidant', 212, 'Drink', 'azera', 4.20, 100, 0, 0, 0, 0, aprod); 
	insertOrders(seq_orderid.currval, aprod, auser, to_Date('04/11/2019 15:10:00', 'DD/MM/YYYY HH24:MI:SS'));
