...
BEGIN
	...
	insertProducts('Caffeinated', 'Turkish Black Tea', 'Tea - Black - Incredibly strong black tea', 'Reduces risk of diabetes', 0, 'Drink', '', 'Caykur', 6.00, 500, 'No Nuts', 'No Dairy', 0.0, 0.0, aprod);
	...
	insertProducts('Frosted cake', 'Red Velvet', 'Cake - Red velvet cake with a cream cheese frosting', 'None', 0, 'Cake', 'Latte', 'Sainsburys', 2.00, 350, 'No Nuts', 'Has Dairy', 38.5, 10.2, aprod);
	
	insertUser('Stuart', 'thestuart@meantinc.com', 'horse', '62 Boat Lane, Resolven, SA11 6NG', 1, to_Date('01/11/2019 09:30:00', 'DD/MM/YYYY HH24:MI:SS'), auser, emcmsg);
	...
	insertOrders(seq_orderid.currval, aprod, auser, to_Date('04/11/2019 15:10:00', 'DD/MM/YYYY HH24:MI:SS'));
	insertProducts('Chocolate cake', 'Chocolate Celebration Cake', 'Cake - Moist, delicious and packed full of chocolate.', 'None', 0, 'Cake', 'Cappuccino', 'Thorntons', 2.20, 600, 'No Nuts', 'Has Dairy', 102.4, 47.4, aprod);
	insertOrders(seq_orderid.currval, aprod, auser, to_Date('04/11/2019 15:10:00', 'DD/MM/YYYY HH24:MI:SS'));
	
	insertUser('JamieG', 'jamiegustav@socialbounty.com', 'van', '96 Stroud Road, Old Craighill, EH22 3ZL', 0, to_Date('03/11/2019 10:30:00', 'DD/MM/YYYY HH24:MI:SS'), auser, emcmsg);
	DBMS_OUTPUT.PUT_LINE(emcmsg);
	insertProducts('Sponge cake', 'Victoria Sponge Cake', 'Cake - Two layers of sponge filled with cream and jam.', 'None', 0, 'Cake', 'Mocha', 'The Craft Company', 2.75, 345, 'No Nuts', 'Has Dairy', 81.0, 18.0, aprod); 
