...
BEGIN 
	...
	VALUES (aorderID, aprodID, auserID, aweight);
END;
/
...
BEGIN
	...
	insertOrders(seq_orderid.nextval, prodID, userID, 1);
	insertProducts('Earl Grey', 'grey', 'herbal', 'pg tips', 8, prodID);
	insertOrders(seq_orderid.currval, prodID, userID, 5);
	...
	insertProducts('espresso', 'black', 'caffinated', 'Azera', 0.5, prodID);
	insertOrders(seq_orderid.nextval, prodID, userID, 10);
END;
/
