...
BEGIN
	...
	insertOrders(seq_orderid.nextval, prodID, userID, 1, to_Date('04/11/2019 15:10:00', 'DD/MM/YYYY HH24:MI:SS'));
	insertProducts('Earl Grey', 'grey', 'herbal', 'pg tips', 8, prodID);
	insertOrders(seq_orderid.currval, prodID, userID, 5, to_Date('04/11/2019 15:10:00', 'DD/MM/YYYY HH24:MI:SS'));
	...
	insertProducts('espresso', 'black', 'caffinated', 'Azera', 0.5, prodID);
	insertOrders(seq_orderid.nextval, prodID, userID, 10, to_Date('04/11/2019 15:10:00', 'DD/MM/YYYY HH24:MI:SS'));
END;
/
